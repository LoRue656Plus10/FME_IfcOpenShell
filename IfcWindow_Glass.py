...
class FeatureProcessor(object):
    ...
    # Creates an IfcAxis2Placement3D from Location, Axis and RefDirection specified as Python tuples
        ...
        # Creates an IfcExtrudedAreaSolid from IfcRectangleProfile
        def create_ifcextrudedareasolid(ifcfile, point_list, ifcaxis2placement, extrude_dir, extrusion):
            polyline = create_ifcpolyline(ifcfile, point_list)
            ifc_rec_profile = ifcfile.createIfcRectangleProfileDef("AREA", feature.getAttribute('FamilyType'), None, feature.getAttribute('XDim'), feature.getAttribute('YDim'))
        ...
        # Create Window components - Glass
        ...
        window_solid = create_ifcextrudedareasolid(ifcfile, ifc_rec_profile, window_extrusion_placement, (0.0, 0.0, 1.0), feature.getAttribute('Dimensions.Height'))
